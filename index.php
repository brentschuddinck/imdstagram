...
<div class="container">
    <div class="row">
        ...
        <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post" enctype="multipart/form-data">
            ...
            ?>
            <textarea name="beschrijving" id="beschrijving" maxlength="1000" rows="6" placeholder="beschrijving foto" required title="Beschrijving kan niet leeg zijn" class="form-control login-field"><?php echo isset($_POST['beschrijving']) && empty($_FILES['foto']['name']) ? htmlspecialchars($_POST['beschrijving']) : '' ?></textarea>
            <div class="col-md-9">
                <input type="file" name="foto" class="btn btn-block btn-lg btn-inverse" >
            </div>
            <div class="col-lg-3">
